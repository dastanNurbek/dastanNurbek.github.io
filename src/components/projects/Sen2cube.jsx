  ...
  return (
    <div className="max-w-[800px] mx-auto w-full px-4 py-8">
        ...
        <div className="justify-items-center">
            <img src="/images/sen-1.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
        ...
        <div className="justify-items-center">
            <img src="/images/sen-2.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
            &nbsp;&nbsp;&nbsp;&nbsp;In the application section, we first merge cloud and ice entities.
        </p>
        <div className="justify-items-center">
            <img src="/images/sen-3.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
        ...
        <div className="justify-items-center">
            <img src="/images/sen-4.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
        ...
        <div className="justify-items-center">
            <img src="/images/sen-5.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
            &nbsp;&nbsp;&nbsp;&nbsp;Traunsee. Estimated area: 24.74 km2, ground truth: 24.5 km2.
        </p>
        <div className="justify-items-center">
            <img src="/images/sen-6.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
            &nbsp;&nbsp;&nbsp;&nbsp;Mondsee. Estimated area: 14.18 km2, ground truth: 14.2 km2.
        </p>
        <div className="justify-items-center">
            <img src="/images/sen-7.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
            &nbsp;&nbsp;&nbsp;&nbsp;Hallstatter See. Estimated area: 8.37 km2, ground truth: 8.55 km2.
        </p>
        <div className="justify-items-center">
            <img src="/images/sen-8.png" alt="Traffic Emission Simulation" className="max-w-lg" />
        </div>
        <p className='my-4'>
